  ...
  return (
    <section className="hero-grid relative flex min-h-[85vh] flex-col items-center justify-center px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10">
        <h1 className="animate-fade-in mb-6 text-5xl font-bold tracking-[0.5em] sm:text-6xl md:text-7xl bg-gradient-to-br from-[var(--color-text)] via-[var(--color-accent)] to-[#6366f1] bg-clip-text text-transparent">
          稻听途说
        </h1>
